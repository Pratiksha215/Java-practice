...
import custom_ordering.BankAccountDateTypeComparator;
			...
			while (!exit) {
				try {
					System.out.println("Menu 1.Create New A/C 2.Display 3. Check for Exists \n"
							...
							+ "12. Sort By balance 13. Sort by Date n balance 14. Sort by Date n Type \n" 
							+ "15 . Sort by Date Anonymous inner class 100.Exit");
					...
					case 13:
						...
						break;
					case 14:
						// sort bank a/cs as per date n type
						BankAccountDateTypeComparator comp = new BankAccountDateTypeComparator();
						Collections.sort(accts, comp);// comp.compare(a1,a2).....
						break;
					case 15:// sort accts as per date
						//new Comparator<BankAccount>() => instance of the class which imple. Comparator<BA>
						Collections.sort(accts, new Comparator<BankAccount>() {
							@Override
							public int compare(BankAccount o1, BankAccount o2) {
								// date based
								System.out.println("ano inner cls : compare");
